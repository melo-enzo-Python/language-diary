...
#Asignación #2. Crear la tabla Usuariocla
class User(db.Model):
    id = db.Column(db.Integer, primary_key=True)
...
def voices():
    try:
        ...
        texto = "hubo un error, intente nuevamente"
...
def voices2():
    try:
        ...
        texto = "hubo un error, intente nuevamente"
    return render_template("create_card.html", texto2= texto2)
